...
def test_elege_menor_nome_lexicografico():
    replies = [
        {"TYPE": "DISCOVERY_REPLY", "MASTER_NAME": "MASTER_2", "MASTER_IP": "1.1.1.2", "MASTER_PORT": 10000},
        {"TYPE": "DISCOVERY_REPLY", "MASTER_NAME": "MASTER_1", "MASTER_IP": "1.1.1.1", "MASTER_PORT": 10000},
        {"TYPE": "DISCOVERY_REPLY", "MASTER_NAME": "MASTER_3", "MASTER_IP": "1.1.1.3", "MASTER_PORT": 10000},
    ]
...
def test_ordenacao_natural_master10_depois_de_master2():
    replies = [
        {"TYPE": "DISCOVERY_REPLY", "MASTER_NAME": "MASTER_10", "MASTER_IP": "1.1.1.10", "MASTER_PORT": 10000},
        {"TYPE": "DISCOVERY_REPLY", "MASTER_NAME": "MASTER_2", "MASTER_IP": "1.1.1.2", "MASTER_PORT": 10000},
    ]
...
def test_elect_ignora_invalidos_e_elege_valido():
    replies = [
        ...
        {"TYPE": "DISCOVERY_REPLY", "MASTER_NAME": "MASTER_4", "MASTER_IP": "1.1.1.4", "MASTER_PORT": 10000},
    ]
